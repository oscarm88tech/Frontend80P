                            ...
                            <form onSubmit={ModificarClientes}>
                                ...
                                <div className='card-body'>
                                    <div className='form-group'>
                                        ...
                                        <input type='text'
                                            className='form-control'
                                            placeholder='Ingrese sus apellidoss'
                                            id='apellidos'
                                            name='apellidos'
                                            value={apellidos}
                                ...
                                <div className='card-body'>
                                    <div className='form-group'>
                                        <label htmlFor='cedula'>Documento identificacion</label>
                                        <input type='number'
                                            className='form-control'
                                ...
                                <div className='card-body'>
                                    <div className='form-group'>
                                        <label htmlFor='numeroContacto'>Telefono</label>
                                        <input type='number'
                                            className='form-control'
                                ...
                                <div className='card-body'>
                                    <div className='form-group'>
                                        <label htmlFor='nit'>Ingrese su nit</label>
                                        <input type='number'
                                            className='form-control'
